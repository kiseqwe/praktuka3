!function() {
    ...
    function e(e) {
        ...
        h && (e.wheelDeltaX && K(e.wheelDeltaX, 120) && (o = e.wheelDeltaX / Math.abs(e.wheelDeltaX) * -120), e.wheelDeltaY && K(e.wheelDeltaY, 120) && (n = e.wheelDeltaY / Math.abs(e.wheelDeltaY) * -120)), o || n || (n = -e.wheelDelta || 0);
        var r = z(t);
        return r ? !!function(e) {
                if (!e) return;
                l.length || (l = [e, e, e]);
    ...
    function x(e) {
        var t = e.target;
        if (e.defaultPrevented || /^(textarea|select|embed|object)$/i.test(t.nodeName) || N(t, "input") && !/(^(checkbox|radio|file|color|image)$)/.test(t.type) || N(s, "video") || t.isContentEditable) return !0;
        if ((N(t, "button") || N(t, "input") && /^(button|submit|radio|checkbox|file|color|image)$/i.test(t.type)) && e.keyCode === w.spacebar) return !0;
        if (N(t, "input") && "radio" == t.type && v[e.keyCode]) return !0;
        var o = 0,
            n = 0,
            r = z(s);
        if (!r) return !d || !W || parent.keydown(e);
        var a = r.clientHeight;
        switch (r == document.body && document.scrollingElement && (r = document.scrollingElement), e.keyCode) {
            case w.up:
                n = -p.arrowScroll;
                break;
            case w.down:
            ...
            case w.pagedown:
                ...
                break;
            case w.home:
                r == document.body && document.scrollingElement && (r = document.scrollingElement), n = -r.scrollTop;
                break;
            case w.end:
